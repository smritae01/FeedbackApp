...
public class QuestionPraf extends JFrame implements ActionListener{
 JLabel q1,q2,q3,q4,q5,q6,q7,q8,prof,dept,pic,limg,l,crs;
...
QuestionPraf(){
   ...
   imp = new ImageIcon(getClass().getResource("praf.jpg"));
   pic = new JLabel(imp);
   pic.setBounds(30,10,110,110);
   c.add(pic);
   prof = new JLabel("Dr Prafulla Kalapatapu",JLabel.LEFT);
   prof.setBounds(30,120,300,20);
   dept = new JLabel("Computer Science and Engineering",JLabel.LEFT);
   dept.setBounds(30,140,300,20);
   crs = new JLabel("Course : Object Oriented Programming",JLabel.LEFT);
   crs.setBounds(30,160,300,20);
   c.add(prof);
   c.add(dept);
   c.add(crs);
            ...
            if(count==1){
             ...
             JOptionPane.showMessageDialog(null, "Feedback Submitted Successfully!");}
              ...
              System.out.println("YES");
               fw = new FileWriter("praf_fb_2.txt");
               fw.write(t1.getText()+"/"+t2.getText()+"/"+t3.getText()+"/"+t4.getText()+"/"+t5.getText()+"/"+t6.getText()+"/"+t7.getText()+"/"+t8.getText());
               fw.close();
               JOptionPane.showMessageDialog(null, "Feedback Submitted Successfully!");}
  ...
  public static void main(String []args){
    QuestionPraf q = new QuestionPraf();
    q.setSize(4096,7016);
