...
Questions(){
   ...
   imp = new ImageIcon(getClass().getResource("adm.png"));
   pic = new JLabel(imp);
   pic.setBounds(30,10,80,80);
   c.add(pic);
   prof = new JLabel("Prof Name",JLabel.LEFT);
   prof.setBounds(30,110,100,20);
   dept = new JLabel("XYZ Department",JLabel.LEFT);
   dept.setBounds(30,130,100,20);
   crs = new JLabel("Course : X",JLabel.LEFT);
   crs.setBounds(30,150,300,20);
   c.add(prof);
   c.add(dept);
   c.add(crs);
