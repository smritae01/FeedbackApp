...
public class TeacherBhargav extends JFrame implements ActionListener{
JButton ad,rem,cf,ca,submit;
Container c;JLabel label,limg,ladn,ldes,lorg,lima;
ImageIcon im,ima;
Desktop desk;

public TeacherBhargav(){
 c = this.getContentPane();
 //c.setBackground(Color.gray);
 c.setLayout(null);

 ima = new ImageIcon(getClass().getResource("bhargav2.jpg"));
 lima = new JLabel(ima);
 lima.setBounds(30,10,100,100);
 c.add(lima);
 ladn = new JLabel("Dr Bhargava Rajaram",JLabel.LEFT);
...
public void actionPerformed(ActionEvent ae){
  ...
  if(s.equals("Check Attendance")){
     ...
     CheckFeedBackE cfa = new CheckFeedBackE();
...
public static void main(String args[]){
  TeacherBhargav af = new TeacherBhargav();
...
class CheckFeedBackE extends JFrame implements ActionListener{
	 private Container c;
