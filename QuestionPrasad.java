...
public class QuestionPrasad extends JFrame implements ActionListener{
...
QuestionPrasad(){
   ...
   imp = new ImageIcon(getClass().getResource("prasad2.jpg"));
   pic = new JLabel(imp);
   pic.setBounds(30,10,150,150);
   c.add(pic);
   prof = new JLabel("Dr. Prasad Pokkunuri",JLabel.LEFT);
   prof.setBounds(30,190,300,20);
   dept = new JLabel("Mechanical Engineering",JLabel.LEFT);
   dept.setBounds(30,210,300,20);
   crs = new JLabel("Course : Theory of Machines",JLabel.LEFT);
  ...
  // crs1 = new JLabel("and Computer Architecture");
   ...
   public void actionPerformed(ActionEvent e){
     ...
     if(e.getSource()==b){
       ...
       try{
             fw = new FileWriter("prasad_fb.txt");
  ...
  public static void main(String []args){
    QuestionPrasad q = new QuestionPrasad();
    q.setSize(4096,7016);
