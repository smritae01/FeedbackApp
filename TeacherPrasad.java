...
public class TeacherPrasad extends JFrame implements ActionListener{
JButton ad,rem,cf,ca,submit;
Container c;JLabel label,limg,ladn,ldes,lorg,lima;
ImageIcon im,ima;
Desktop desk;

public TeacherPrasad(){
 c = this.getContentPane();
 //c.setBackground(Color.gray);
 c.setLayout(null);

 ima = new ImageIcon(getClass().getResource("prasad2.jpg"));
 lima = new JLabel(ima);
 lima.setBounds(30,10,100,100);
 c.add(lima);
 ladn = new JLabel("Dr Prasad Pokkunuri",JLabel.LEFT);
...
public void actionPerformed(ActionEvent ae){
  ...
  if(s.equals("Check Attendance")){
     ...
     CheckFeedBackM cfa = new CheckFeedBackM();
...
public static void main(String args[]){
  TeacherPrasad af = new TeacherPrasad();
...
class CheckFeedBackM extends JFrame implements ActionListener{
	 private Container c;
