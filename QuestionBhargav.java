...
public class QuestionBhargav extends JFrame implements ActionListener{
...
QuestionBhargav(){
   ...
   imp = new ImageIcon(getClass().getResource("bhargav2.jpg"));
   pic = new JLabel(imp);
   pic.setBounds(30,10,150,150);
   c.add(pic);
   prof = new JLabel("Dr. Bhargav Rajaram",JLabel.LEFT);
   prof.setBounds(30,190,300,20);
   dept = new JLabel("Electrical and Electronics Engineering",JLabel.LEFT);
   dept.setBounds(30,210,300,20);
   crs = new JLabel("Course : Digital Electronics",JLabel.LEFT);
  ...
  // crs1 = new JLabel("and Computer Architecture");
   ...
   public void actionPerformed(ActionEvent e){
     ...
     if(e.getSource()==b){
       ...
       try{
             fw = new FileWriter("bhargav_fb.txt");
  ...
  public static void main(String []args){
    QuestionBhargav q = new QuestionBhargav();
    q.setSize(4096,7016);
